    ...
    <div className='row g-5 g-xl-10 mb-5 mb-xl-10'>
      <div className='col-md-12 mb-5 text-center'>
        <div className='card card-ab shadow-sm d-flex flex-row align-items-center justify-content-between p-5'>
          <h1 className='animated-text'>WELCOME TO CONNECT DSU ALUMNI</h1>
        </div>
      </div>
      <div className='row g-5 g-xl-10 mb-5 mb-xl-10'>
        {/*begin::Col*/}
          ...
          >
            ...
            <div className='card-header pt-5'>
              ...
              <div className='card-title d-flex flex-column'>
                ...
                {/*end::Amount*/}
                {/*begin::Subtitle*/}
                <span className='text-white opacity-75 pt-1 fw-semibold fs-6'>Active Users</span>
                {/*end::Subtitle*/}
              </div>
              {/*end::Title*/}
            </div>
          ...
          >
            ...
            <div className='card-header pt-5'>
              ...
              <div className='card-title d-flex flex-column'>
                ...
                {/*end::Amount*/}
                {/*begin::Subtitle*/}
                <span className='text-white opacity-75 pt-1 fw-semibold fs-6'>Approve Jobs</span>
                {/*end::Subtitle*/}
              </div>
              {/*end::Title*/}
            </div>
          ...
          <div className='card card-flush h-md-100'>
            ...
            >
              ...
              <img
                ...
                alt=''
              />
              <img className='mx-auto h-150px h-lg-200px theme-dark-show' src={fame} alt='' />
              {/*end::Illustration*/}
            </div>
            {/*end::Body*/}
          </div>
