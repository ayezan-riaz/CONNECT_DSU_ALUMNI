      ...
      <div className='card card-ad hover shadow-md mb-5 mb-xl-8 mt-8'>
        <div className='card-header border-0 pt-5'>
          <h3 className='card-title align-items-start flex-column'>
            <span className='card-label fw-bold fs-1 mb-1'>Users</span>
            ...
            <div className='card'>
              <div className='card-body'>
                ...
                <div className='user-details'>
                  ...
                  <p>
                    <strong>University Email:</strong> {viewUser.uni_email}
                  </p>
                  <p>
                    <strong>Phone:</strong> {viewUser.phone}
                  </p>
                  <p>
                    <strong>Number of Jobs Posted:</strong> {viewUser.noOfJobsPosted}
                  </p>
                  <p>
                    <strong>Designation:</strong> {viewUser.designation}
                  </p>
                  <p>
                    <strong>Qualification:</strong> {viewUser.qualification}
                  </p>
                  <p>
                    <strong>Company:</strong> {viewUser.company}
                  </p>
                </div>
              </div>
            </div>
