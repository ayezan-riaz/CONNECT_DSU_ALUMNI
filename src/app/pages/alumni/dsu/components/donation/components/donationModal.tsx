  ...
  return (
    <Card>
      <Card.Header style={{backgroundColor: '#80171d'}}>
        <h4 style={{marginTop: '20px', fontSize: '26px', fontWeight: '500', color: 'white'}}>
      ...
      <Card.Body>
        <Form onSubmit={handleSubmit}>
          <Form.Group controlId='paymentMethod' className='form-inline'>
            ...
            >
              <ToggleButton variant='outline-dark' value='online'>
                Online
              </ToggleButton>
              <ToggleButton variant='outline-white' value='accountDeposits'>
                Account Deposits
              </ToggleButton>
            </ToggleButtonGroup>
          </Form.Group>
