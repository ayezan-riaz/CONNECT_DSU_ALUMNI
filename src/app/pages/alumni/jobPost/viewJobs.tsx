...
const ViewJobs: React.FC = () => {
  ...
  const fetchJobs = () => {
    axios.get<Job[]>('https://ams-backend-gkxg.onrender.com/api/jobs')
      .then(response => {
  ...
  const handleDeleteConfirmation = () => {
    if (selectedJob) {
      axios.delete(`https://ams-backend-gkxg.onrender.com/api/jobs/${selectedJob.id}`)
        .then(() => {
  ...
  return (
    <div>
          ...
          <div key={index} className="col-lg-4 col-md-4 col-sm-12">
            <div className="card card-custom card-stretch-50 shadow mb-5">
                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <p className="">
                      ...
                      {job.salary_type} {job.salary} {job.schedule_metrics}</p>
                  </div>
                  <div className="col-12">
                    <p className="">
              ...
              <div className="card-footer">
                ...
                <a href={`https://ams-backend-gkxg.onrender.com/api/jobs/${job.id}`} target="_blank" rel="noopener noreferrer" className="btn btn-primary">
                  Apply Now
                </a>
              </div>
            </div>
      ...
      <JobPosting isOpen={showModal} onClose={closeModal} selectedJob={selectedJob} fetchJobs={fetchJobs} />
